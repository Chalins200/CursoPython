...
p1 = Pizza("XL",100,["Piña"])
p2 = Pizza("L",100,["Chorizo"])
p3 = Pizza("M",100,["Camaron"])
p4 = Pizza("S",100,["Queso"])
p5 = Pizza("XL",100,["Chorizo"])
p6 = Pizza("M",100,["Mexicana"])
p7 = Pizza("L",100,["Camaron"])
...
ranking_ingredientes = ["Piña","Chorizo","Camaron","Queso",
                        "Chorizo","Mexicana","Camaron"]
...
dic = defaultdict(int)
print("Valor:", dic["Chorizo"])
print("Valor:", dic["Chorizo"])
print("Valor:",dic["Pepinillos"])
